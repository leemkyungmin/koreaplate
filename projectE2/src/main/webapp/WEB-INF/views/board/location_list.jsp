...
<link href="resources/assets/style/locationlist.css" rel="stylesheet"
	type="text/css">
...
<article class="contents">
	<header class="basic-info-list">
		<div class="inner" style="padding-bottom: 10px">
			<h1 class="title">${location_count.dong}
				맛집${location_count.count }곳</h1>
			<h2 class="desc">“${location_count.dong} 맛집 베스트”</h2>
		</div>
	</header>

	<div class="container-list" id="contents_width">
		<div class="inner">
			<div class="ad_area right_space only-desktop"
				id="web_desktop-toplist-right_space">
				<div class="ad_wrap">
					<div class="content" id="web_desktop-toplist-right_space-content"
						data-google-query-id="CLHRvJ3bweoCFQWewgody_MIow">
						<div
							id="google_ads_iframe_/395211568/alpha/desktop-web.toplist.right-side_0__container__"
							style="border: 0pt none; display: inline-block; width: 160px; height: 600px;">
							<iframe frameborder="0"
								src="https://f431e69df376240d008dc454aec7ffb4.safeframe.googlesyndication.com/safeframe/1-0-37/html/container.html"
								id="google_ads_iframe_/395211568/alpha/desktop-web.toplist.right-side_0"
								...
								<figure class="restaurant-item">
									<a href="viewPage?dSaup_no=${list.dSaup_no }">
										<div class="thumb">
											...
											<img class="center-croping lazy" alt="${list.dName } 메인사진"
												src="${pageContext.request.contextPath }/resources/storage/department_img/${fn:substring(img,0,img_index)}">
										</div>
									</a>
									<figcaption>
										<div class="info">
											...
											<span class="title "> <a
												href="viewPage?dSaup_no=${list.dSaup_no }">
													${index.count }.
													<h3>${list.dName}</h3>
											</a>
											</span> <strong class="point  "> <span>${list.dRating}</span>
											</strong>
