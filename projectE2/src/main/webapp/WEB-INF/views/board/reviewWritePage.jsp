...
<body>
	<c:if test="${sessionScope.dSaup_no !=null }">
		<script type="text/javascript">
			...
			location.href = 'viewPage?dSaup_no=' + $
			{
				deptDTO.dSaup_no
			};
		</script>
	...
	<form name="myForm" method="post" enctype="multipart/form-data">
		<div class="ReviewWritenpage_Container">
			...
			<div class="ReviewPoint">
				<p id="star_grade">
					<a onclick="mark(1)">★</a> <a onclick="mark(2)">★</a> <a
						onclick="mark(3)">★</a> <a onclick="mark(4)">★</a> <a
						onclick="mark(5)">★</a>
				</p>
			...
			<div class="ReviewWritenPage_ButtonsWrap">
				...
				<input type="button" class="ReviewWritingPage_CalcelButton"
					...
					onclick="fn_insertReview(this.form)" value="리뷰 올리기" />
			</div>
		</div>
	</form>
