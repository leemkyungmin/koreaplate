...
<link rel="stylesheet" href="resources/assets/style/main-nav.css"
	type="text/css">
	...
	$(function() {
		...
		for (var i = json_list.length - 1; i >= 0; i--) {
			for (key in json_list[i]) {
				if (json_list[i][key] != "") {
					html += '<div class="item"><a href="searchPage?main-search='
							+ json_list[i][key]
							+ '">'
							+ json_list[i][key]
							+ '</a></div>';
...
<div class="header-wrap">
	...
	<div class="search-wrap">
		<div class="main-search">
			...
			<form class="search-form" action="searchPage">
				<input id="search-input" class="HomeSearchInput" name="main-search"
					type="text" maxlength="50" placeholder="지역명, 맛집 이름"
					autocomplete="off"> <input class="btn-search"
	...
	<video autoplay loop muted>
		<source
			src="<c:url value="/resources/assets/video/indexvideo01.mp4" />"
			type="video/mp4">
	</video>
</div>
