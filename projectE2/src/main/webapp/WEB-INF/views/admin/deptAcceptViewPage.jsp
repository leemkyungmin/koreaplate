...
<link href="resources/assets/style/admin/sb-admin-2.min.css"
	rel="stylesheet">
...
<div id="wrapper">
	...
	<ul
		...
		<li class="nav-item"><a class="nav-link" href="index"> <i
				class="fas fa-fw fa-tachometer-alt"></i> <span>메인페이지</span>
		</a></li>

		<!-- Divider -->
		<hr class="sidebar-divider my-0">
		<li class="nav-item"><a class="nav-link" href="adminmanagePage">
				<span>일반회원관리</span>
		</a></li>
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			aria-expanded="true" aria-controls="collapseTwo"> <span>기업회원관리</span>
		</a>
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
				data-parent="#accordionSidebar">
				<div class="bg-white py-2 collapse-inner rounded">
					<h6 class="collapse-header"></h6>
					<a class="collapse-item" href="departmentView">업체 정보</a> <a
						class="collapse-item" href="deptAccpetPage">업체 승인 대기목록</a>
				</div>
			</div></li>
	</ul>
	<!-- End of Sidebar -->
		...
		<div id="content" style="height: 90%;">
			...
			<div class="container-fluid" style="height: 100%;">
				...
				<div class="row" style="height: 100%; width: 100%;">
					<div class="col-xl-8"
						style="flex: 0 0 100%; max-width: 100%; margin-top: 20px;">
						<!-- Area Chart -->
						<div class="card shadow mb-4" style="height: 95%; width: 100%;">
							...
							<div class="card-body" style="height: 100%;">
								<div class="chart-area" style="height: 100%;">
									<!-- 내용 부분 -->
									<div id="custom"
										style="width: 66.5%; margin: auto; margin-top: 50px;">
										<div class="wrap">
											<form method="post">
												<table>
													<tr>
												...
												<div class="btn_wrap">
													...
													<input class="small_btn" type="button" value="목록"
														onclick="location.href='deptAccpetPage'" /> <input
														class="btn" type="button" value="승인"
														onclick="endorse(this.form)" /> <input class="btn"
														type="button" value="거절" onclick="reject(this.form)" />
												</div>
											</form>
										</div>
									</div>
...
<script
	src="resources/assets/style/admin/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- Core plugin JavaScript-->
<script
	src="resources/assets/style/admin/jquery-easing/jquery.easing.min.js"></script>
