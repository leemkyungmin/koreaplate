					...
					$.ajax({
						...
						success : function(data) {
							...
							if (data == '1') {
								ans = '중복된 사업자 번호입니다.';
								color = 'red';
							} else if ($('#dSaup_no').val() != ''
									&& data == '0'
									&& ($('#dSaup_no').val().length == 11)) {
...
11. 고지의무
			...
			<div class="form-group" id="divId">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control onlyAlphabetAndNumber"
						name="dId" id="id" data-rule-required="true"
			...
			<div class="form-group" id="divPassword">
				...
				<div class="col-lg-10">
					<input type="password" class="form-control" id="password"
						name="dPw" data-rule-required="true" placeholder="패스워드"
						maxlength="30">
				</div>
			</div>
			...
			<div class="form-group" id="divPhoneNumber">
				<label for="inputPhoneNumber" class="col-lg-2 control-label">사업자
					번호</label>
				<div class="col-lg-10">
					<input type="tel" class="form-control onlyNumber" id="dSaup_no"
