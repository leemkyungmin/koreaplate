					...
					$.ajax({
						...
						success : function(data) {
							...
							if (data == '1') {
								ans = '중복된 이메일 입니다.';
								color = 'red';
							} else if ($('#email').val() != '' && data == '0'
									&& emailRule.test($('#email').val())) {
								$('#emailAuth').css('display', 'block')
								ans = '가입 가능한 이메일 입니다.';
								color = 'blue';
								emailPass = true;
							} else if (!emailRule.test($("input[id='email']")
									.val())) {
								ans = '올바른 이메일을 입력하세요.';
								color = 'red';
							} else {
...
<body>
	<div class="container">
		...
		<div class="row">
			<p></p>
			<div class="col-md-12">
				<small> <a href="loginChoicePage">로그인</a>
				</small>
			</div>
		</div>
		<!--// 헤더 들어가는 부분 -->
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form>
						<div class="modal-body">
							<p class="modal-contents"></p>
							<br /> <input type="text" id="emailAuthNum" name="emailAuthNum"
								placeholder="인증번호를 입력하세요."> <input type="button"
								id="emailAuthBtn" value="인증하기" />
		...
		<form class="form-horizontal" id="loginForm" role="form" method="post"
			action="customerSignUp" enctype="multipart/form-data">
...
11. 고지의무
			...
			<div class="form-group" id="divId">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control onlyAlphabetAndNumber"
						...
						placeholder="30자이내의 알파벳, 언더스코어(_), 숫자만 입력 가능합니다." maxlength="30"><br />
					<div id="temp" class="temp"></div>
				</div>
				<div class="check-font" id="id_check">
					&nbsp;&nbsp; <input type="button" class="btn btn-primary"
						value="중복체크" id="idCheckBtn" name="idCheckBtn" />
			...
			<div class="form-group" id="divPassword">
				...
				<div class="col-lg-10">
					<input type="password" class="form-control" id="password"
						name="cPw" data-rule-required="true" placeholder="패스워드"
						maxlength="30">
				</div>
			</div>
			...
			<div class="form-group" id="divEmail">
				...
				<div class="col-lg-10">
					...
					<br /> <input type="button" id="emailCheck" name="emailCheck"
						value="이메일 중복체크" class="btn btn-primary" /> &nbsp;&nbsp;&nbsp; <input
						type="button" id="emailAuth" name="emailAuth" value="이메일 인증"
			...
			<div class="form-group" id="divPhoneNumber">
				...
				<div class="col-lg-10">
					<input type="tel" class="form-control onlyNumber" id="phoneNumber"
						name="cPhone" data-rule-required="true"
