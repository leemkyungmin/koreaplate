...
<body>
	<div class="selectButton">
		<div class="customer">일반 회원 로그인</div>
		<div class="dept">업체 회원 로그인</div>
	</div>
	<div class="customerWrap" style="width: 20rem; border-radius: 20px;">
		<div class="card-title" style="margin-top: 30px;">
			<h2 class="card-title text-center" style="color: #113366;">일반회원
				로그인</h2>
		</div>
		<div class="card-body">
			<form class="form-signin" method="POST">
				...
				<label for="inputEmail" class="sr-only">Your ID</label> <input
					type="text" id="cId" name="cId" class="form-control"
					placeholder="Your ID" required autofocus><BR> <label
					for="inputPassword" class="sr-only">Password</label> <input
					type="password" id="cPw" name="cPw" class="form-control"
					placeholder="Password" required><br>
				<div class="checkbox">
					<label> <input type="checkbox" value="true"
						id="saveIDCheck" name="saveIDCheck"> 기억하기
					</label>
				</div>
				<div style="text-align: center;">
					<a href="findUserIdPw">아이디/비밀번호 찾기</a> <br /> <a
						href="customerSignUp">회원가입</a>
				</div>
	...
	<div class="departmentWrap" style="width: 20rem; border-radius: 20px;">
		<div class="card-title" style="margin-top: 30px;">
			<h2 class="card-title text-center" style="color: #113366;">업체
				로그인</h2>
		</div>
		<div class="card-body">
			<form class="form-signin" method="POST"
				...
				<h5 class="form-signin-heading">로그인 정보를 입력하세요</h5>
				<label for="inputEmail" class="sr-only">Your ID</label> <input
					type="text" id="dId" class="form-control" placeholder="Your ID"
					required autofocus><BR> <label for="inputPassword"
					class="sr-only">Password</label> <input type="password" id="dPw"
				...
				<div style="text-align: center;">
					<a href="findDeptIdPw">아이디 / 비밀번호 찾기</a> <br /> <a
						href="deptSignUpPage">업체 회원가입</a>
				</div>
				<input id="login_dept" name="login_dept"
					class="btn btn-lg btn-primary btn-block" type="button"
					value="로 그 인" />
			</form>
	...
	<div class="g-recaptcha"
		data-sitekey="6Lfi_rEZAAAAAJofp01ZBq9JJ5p3cwmrXPyG6ecS"></div>
	<div class="modal"></div>
	<!-- Optional JavaScript -->
